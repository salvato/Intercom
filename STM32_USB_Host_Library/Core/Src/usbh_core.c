...
static
USBH_StatusTypeDef
DeInitStateMachine(USBH_HandleTypeDef *phost) {
    uint32_t i = 0U;
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_SelectInterface(USBH_HandleTypeDef *phost, uint8_t interface) {
    USBH_StatusTypeDef   status = USBH_OK;
...
/**
  ...
  */
uint8_t
USBH_GetActiveClass(USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_Start  (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_Stop   (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_ReEnumerate(USBH_HandleTypeDef *phost) {
    /*Stop Host */
    USBH_Stop(phost);
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_Process(USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
void
USBH_LL_SetTimer  (USBH_HandleTypeDef *phost, uint32_t time) {
    phost->Timer = time;
}
...
/**
  ...
  */
void
USBH_LL_IncTimer  (USBH_HandleTypeDef *phost) {
    phost->Timer ++;
...
/**
  ...
  */
static void
USBH_HandleSof  (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
void
USBH_LL_PortEnabled (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
void
USBH_LL_PortDisabled (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
uint8_t
USBH_IsPortEnabled(USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_LL_Connect (USBH_HandleTypeDef *phost) {
...
/**
  ...
  */
USBH_StatusTypeDef
USBH_LL_Disconnect  (USBH_HandleTypeDef *phost) {
    /*Stop Host */
    USBH_LL_Stop(phost);
...
#if (osCMSIS < 0x20000U)
static void
USBH_Process_OS(void const *argument) {
    osEvent event;
...
*/
USBH_StatusTypeDef
USBH_LL_NotifyURBChange (USBH_HandleTypeDef *phost) {
    phost->os_msg = (uint32_t)USBH_PORT_EVENT;
